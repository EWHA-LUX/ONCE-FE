...
class SearchCard1 extends StatefulWidget {
  const SearchCard1({Key? key}) : super(key: key);

  @override
  _SearchCard1State createState() => _SearchCard1State();
}

class _SearchCard1State extends State<SearchCard1> {
